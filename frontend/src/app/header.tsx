...
export default function Header() {
    ...
    return (
      ...
      <div className={"border-b-2 hover:border-orange-500 [&>*]:hover:text-orange-500"}>
        <button onClick={()=>{router.push("/CheckinPage")}} className={"font-bold hover:text-orange-500 text-white text-3xl px-6 py-2 bg-none rounded"}>
          My Ticket
        </button>
        </div>
        <div className="border-b-2 hover:border-orange-500 [&>*]:hover:text-orange-500">
        <button onClick={()=>{router.push("/Timer")}} className="font-bold text-3xl px-6 py-2 bg-none hover:text-orange-500 text-white rounded">
          Schedule
        </button>
      </div>
      <div className="border-b-2 hover:border-orange-500 [&>*]:hover:text-orange-500">
        <button onClick={()=>{router.push("/foodSection")}} className="font-bold text-3xl px-6 py-2 bg-none hover:text-orange-500 text-white rounded">
          Meals
        </button>
      </div>
      <div className="border-b-2 hover:border-orange-500 [&>*]:hover:text-orange-500">
        <button onClick={()=>{router.push("/Sponsors")}} className="font-bold text-3xl px-6 py-2 bg-none hover:text-orange-500 text-white rounded">
          Sponsors
        </button>
      </div>
    </div>
